...
A modular workspace for machine learning workflows in High Energy Physics (HEP), with an emphasis on scalable training, reproducibility, and experimentation on distributed systems. Originally forked from [the HWW-Tagger](https://gitlab.nrp-nautilus.io/raghsthebest/hww-tagger) and [the Particle Transformer](https://github.com/jet-universe/particle_transformer/tree/main#) repositories, combined for convenience.
